...
ctld.spawnableCrates = {
    ...
    ["Ground Forces"] = {
        ...
        { weight = 520, desc = "HMMWV - JTAC", unit = "Hummer", side = 2, }, -- used as jtac and unarmed, not on the crate list if JTAC is disabled - "M1126 Stryker ICV"
				{ weight = 526, desc = "Striker - JTAC Mirage", unit = "M1126 Stryker ICV", side = 2, },
...
ctld.jtacUnitTypes = {
    "SKP", "Hummer", "M1126 Stryker ICV" -- there are some wierd encoding issues so if you write SKP-11 it wont match as the - sign is encoded differently...
}

ctld.jtacForMirageUnitTypes = {
		"M1126 Stryker ICV"
}
-- ***************************************************************
                   ...
                   -- end
                    ...
                    if ctld.isJTACUnitType(_crate.details.unit) and ctld.JTAC_dropEnabled then
                        ...
                        table.insert(ctld.jtacGeneratedLaserCodes, _code)
												...
												if ctld.isJTACForMirageUnitType(_crate.details.unit) then
													_code = 1688
												end
...
function ctld.isJTACForMirageUnitType(_type)

    _type = string.lower(_type)

    for _, _name in ipairs(ctld.jtacForMirageUnitTypes) do
        local _nameLower = string.lower(_name)
        if string.match(_type, _nameLower) then
            return true
        end
